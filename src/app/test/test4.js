...
describe('Compact component', function() {
    const eventsCount = 4;
    const targetEnabled = window.document.querySelector('div#compact_enabled');
    const targetDisabled = window.document.querySelector('div#compact_disabled');
